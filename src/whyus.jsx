...
import img1 from "./Assets/datacenter.png"
            ...
            <Container fluid className='mt-5 ' >
                <Row>
                    <Col lg={5} md={12} sm={12} style={{display:"flex",justifyContent:"center"}}>
                        <img src={img1} alt="" width={"550px"} className='whyusimg animate__animated animate__fadeInLeft'/>
                    </Col>
                    <Col lg={6} md={12} sm={12} className='whyuscol'>
